      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        >
          ...
          >
            ...
            >
              <Link href="/booking" prefetch={true} className="relative inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 bg-primary-600 text-white rounded-lg font-semibold text-base sm:text-lg md:text-xl shadow-lg hover:shadow-xl transition-all duration-300 group border-2 border-primary-700 overflow-hidden">
            ...
            >
              <Link
                href="/services"
                prefetch={true}
                className="relative inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 bg-primary-600 text-white rounded-lg font-semibold text-base sm:text-lg md:text-xl shadow-lg hover:shadow-xl transition-all duration-300 group border-2 border-primary-700 overflow-hidden"
              >
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative bg-primary-600 rounded-lg p-3 sm:p-4 md:p-5 shadow-lg hover:shadow-xl transform transition-all duration-300 border-2 border-primary-700 overflow-hidden">
